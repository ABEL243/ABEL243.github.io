...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 28,
        minZoom: 1,
        extent: [-1283956.444649, -10462.668807, 1683856.401887, 1728522.955858],
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-1283956.444649, -10462.668807, 1683856.401887, 1728522.955858], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Repartion des tribunaux au Togo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (357 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ce webmapping représente la répartition spatiale des différents tribunaux sur l’ensemble du territoire national. Il permet de visualiser leur localisation, leur typologie ainsi que leurs principales caractéristiques, notamment leur accès à l’électricité, à l’eau et à Internet, ainsi que le nombre d’ordinateurs fonctionnels disponibles dans chaque tribunal';
            }
